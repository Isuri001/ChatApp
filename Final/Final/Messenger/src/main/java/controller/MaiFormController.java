...
public class MaiFormController {
    ...
    public void imgChooseOnAction(ActionEvent actionEvent) {
        final FileChooser fileChooser = new FileChooser();
        File file = fileChooser.showOpenDialog((Stage) (btnChooseImg.getScene().getWindow()));
        if (file != null) {
